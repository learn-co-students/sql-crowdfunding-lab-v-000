...
-- ("Recording an album", "Music", 10000, 4/01/16, 5/01/16),
-- ("Starting Organic Community Garden", "Community", 50000, 4/15/16, 6/01/16),
-- ("Scholarship for Flat Iron Full Stack Program", "Education", 100000, 4/05/16, 5/05/16)
-- ("")
