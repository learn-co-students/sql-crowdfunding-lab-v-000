...
"SELECT projects.title, (SUM(pledges.amount) - projects.funding_goal) AS net_pledge FROM projects JOIN pledges ON projects.id = pledges.project_id GROUP BY projects.title HAVING net_pledge >= 0;"
end
