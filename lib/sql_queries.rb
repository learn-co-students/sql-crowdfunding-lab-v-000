...
"SELECT projects.category, pledges.amount FROM projects JOIN pledges ON pledges.project_id = projects.id GROUP BY pledges.id HAVING projects.category = 'music'"
end
