...
"SELECT projects.title, SUM(pledges.amount) - projects.funding_goal AS funded_projects FROM pledges INNER JOIN projects ON pledges.project_id = projects.id GROUP BY projects.title HAVING funded_projects >=0"
end
