...
# In the below query I didn't use ORDER BY because when I was testing it out it simply returned the list in alphabetized order.
...
"SELECT projects.category, pledges.amount AS amount_pledged
FROM projects
INNER JOIN pledges ON projects.id = pledges.project_id
