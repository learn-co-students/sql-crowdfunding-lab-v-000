...
"SELECT users.name, SUM(pledges.amount) FROM users INNER JOIN pledges on users.id = pledges.user_id GROUP BY users.name ORDER BY SUM(pledges.amount) ASC, users.name;"
end
