...
"SELECT projects.title, pledges.amount FROM projects INNER JOIN pledges ON projects.id = pledges.project_id WHERE projects.funding_goal <= pledges.amount GROUP BY project_id"
end
