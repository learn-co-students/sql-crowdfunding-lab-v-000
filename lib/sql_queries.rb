...
"SELECT projects.title, (SUM(pledges.amount) - projects.funding_goal) AS sum_left FROM projects JOIN pledges ON projects.id = pledges.project_id GROUP BY projects.title HAVING sum_left >= 0 ;"
end
