...
#select title.projects, and the corresponding pledges.amount for each project, sum the pledges.amount and combine results
...
FROM users INNER JOIN pledges ON
