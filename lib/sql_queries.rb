...
"SELECT title,pledges.amount from projects join pledges on pledges.project_id=projects.id GROUP BY title HAVING sum(pledges.amount)=projects.funding_goal"
end
