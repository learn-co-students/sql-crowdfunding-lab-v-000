...
def selects_the_category_name_and_the_sum_total_of_the_all_its_pledges_for_the_books_category
  "SELECTS projects.category, SUM(pledges.amount) FROM Pledges LEFT OUTER JOIN Projects ON Projects.id = Pledges.project_id GROUP BY(projects.category) WHERE projects.category = 'books'"
end
