...
def selects_the_titles_and_amount_over_goal_of_all_projects_that_have_met_their_funding_goal
  ...
  AS pledged_above_goal
  FROM projects
  INNER JOIN pledges ON projects.id = pledges.project_id
  GROUP BY projects.title HAVING pledged_above_goal >= 0;"
end
...
def selects_the_category_names_and_pledge_amounts_of_all_pledges_in_the_music_category
  "SELECT projects.category AS project_category, pledges.amount AS pledged_amount FROM projects
  INNER JOIN pledges ON projects.id = pledges.project_id
...
def selects_the_category_name_and_the_sum_total_of_the_all_its_pledges_for_the_books_category
  "SELECT projects.category AS project_category, SUM(pledges.amount) AS pledged_amount FROM projects
  INNER JOIN pledges ON projects.id = pledges.project_id
