...
"SELECT projects.title, SUM(pledges.amount) - projects.funding_goal as remainig FROM projects INNER JOIN pledges ON projects.id = pledges.project_id GROUP BY projects.id HAVING remainig >= 0;"
end
