...
# "SELECT projects.title, SUM(pledges.amount) - projects.funding_goal FROM pledges INNER JOIN projects ON projects.id=pledges.project_id GROUP BY(projects.title);"
end
