...
"SELECT users.name, SUM(pledges.amount) AS total_amount FROM users JOIN pledges ON users.id = pledges.user_id GROUP BY users.name ORDER BY total_amount, users.name;"
end
