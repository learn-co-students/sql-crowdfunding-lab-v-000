...
"SELECT projects.title, projects.funding_goal - SUM(pledges.amount) AS funding FROM projects JOIN pledges ON projects.id = pledges.project_id GROUP BY pledges.project_id HAVING funding <= 0;"
end
