...
"SELECT title, (SUM(pledges.amount) - projects.funding_goal) AS over_goal FROM projects
...
"SELECT users.name, SUM(pledges.amount) AS total_pledge FROM pledges
...
"SELECT category, pledges.amount FROM pledges
