...
def selects_user_names_and_amounts_of_all_pledges_grouped_by_name_then_orders_them_by_the_amount
  "SELECT users.name, SUM(pledges.amount) AS pledge_total FROM users JOIN pledges ON users.id = pledges.user_id GROUP BY users.name ORDER BY(pledge_total) ASC"
end
