...
"SELECT projects.title, SUM((projects.funding_goal - pledges.amount)) FROM projects JOIN pledges WHERE pledges.amount >= projects.funding_goal GROUP BY projects.title"
end
