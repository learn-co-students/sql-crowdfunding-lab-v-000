...
"SELECT projects.category, SUM(pledges.amount) FROM pledges JOIN projects ON projects.id = pledges.project_id WHERE projects.category = \"books\" GROUP BY projects.category;"
end
