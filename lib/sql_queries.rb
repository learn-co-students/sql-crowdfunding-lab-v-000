...
"SELECT projects.title, sum(pledges.amount) - projects.funding_goal FROM projects JOIN pledges ON pledges.project_id = projects.id GROUP BY projects.title HAVING sum(pledges.amount) - projects.funding_goal > -1;"
end
