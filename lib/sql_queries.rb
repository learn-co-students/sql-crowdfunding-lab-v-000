...
"SELECT title,pledges.amount from projects join pledges on pledges.project_id=projects.id ORDER BY title WHERE sum(pledges.amount)=projects.funding_goal"
end
