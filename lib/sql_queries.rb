...
"SELECT projects.title, (SUM(pledges.amount) - projects.funding_goal) AS funding_needed FROM projects JOIN pledges on projects.id = pledges.project_id GROUP BY projects.id HAVING funding_needed >=0"
end
