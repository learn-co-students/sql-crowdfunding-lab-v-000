...
"SELECT projects.title, (projects.funding_goal - SUM(pledges.amount)) AS Xtra FROM projects JOIN pledges ON projects.id = pledges.project_id GROUP BY projects.title HAVING Xtra <= 0;"
end
